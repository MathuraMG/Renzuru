...
{
	document.getElementById('ImageBox').style.height= screen.height - 240;
	document.getElementById('ImageBoxInner').style.height= screen.height - 240;
	document.getElementById('ImageMain').style.maxHeight= screen.height - 310;
}
function getScrollHeightDesc()
{
	document.getElementById('ImageMain').style.maxHeight= screen.height - 500;
}
function setActiveTab( clickedId )
{
	document.getElementById( clickedId ).className = "MenuBoxActive";
}
function getImageDescDM( clickedId )
{
	if(  clickedId == "Image1" )
...
function getImageDescPen( clickedId )
{
	if(  clickedId == "Image1" )
		...
		document.getElementById('Desc').innerHTML ="Pen Sketch <br> Size: 10.0\" x 7.5\" <br> Original Piece";
	else if(  clickedId == "Image8" )
		document.getElementById('Desc').innerHTML ="Pen Sketch <br> Size: 11.7\" x 16.5\" <br> Original Piece";
	else if(  clickedId == "Image9" )
		document.getElementById('Desc').innerHTML ="Pen Sketch <br> Size: 11.7\" x 16.5\" <br> Original Piece";
	else if(  clickedId == "Image10" )
		document.getElementById('Desc').innerHTML ="Pen Sketch <br> Size: 16.5\" x 11.7\" <br> Inspired by M.C. Escher";
	else if(  clickedId == "Image11" )
		document.getElementById('Desc').innerHTML ="Pen Sketch <br> Size: 22.0\" x 17.0\" <br> Original Piece";
	else if(  clickedId == "Image12" )
		document.getElementById('Desc').innerHTML ="Pen Sketch <br> Size: 8.5\" x 11.0\"  <br> Inspired by photograph";
}
...
function getImageDescOthers( clickedId )
{
	if(  clickedId == "Image1" )
		...
		document.getElementById('Desc').innerHTML ="Kirigami <br> Size: 17.0\" x 22.0\" <br>";
	else if(  clickedId == "Image5" )
		document.getElementById('Desc').innerHTML ="Kirigami <br> Size: 12.0\" x 12.0\" <br>Chess board!";
}